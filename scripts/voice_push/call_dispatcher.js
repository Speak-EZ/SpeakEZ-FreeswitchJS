...
var call_string_pre = "originate {ignore_early_media=true,origination_caller_id_name=SpeakEZ,origination_caller_id_number=+13152165268}";
var arg = argv;
...
if(validataion_flag) {
	...
	*/
	...
	for (i = 0; i < recipient_no.length; i++) {
		...
		//delay between call
		console_log('warning', 'call initiated\n');
		msleep(call_delay_interval);
		console_log('warning', 'finish interval, init next call\n');
	}
